const mealRandomImgContainer = document.querySelector(
  ".randommeal_container_general_img img"
);
const mealRandomTitleContainer = document.querySelector(
  ".randommeal_container_general_fav h2"
);
const btnRandomMeal = document.querySelector(
  ".randommeal_container_general_img button"
);
const btnFav = document.querySelector(
  ".randommeal_container_general_fav button"
);
const btnFavIcon = document.querySelector(
  ".randommeal_container_general_fav button i"
);
const historyContainer = document.querySelector(".history_container");
const informationHistoryContainer = document.querySelector(
  ".informationhistory_container"
);
...
const btnCloseSideBar = document.querySelector(
  ".sidebarcontainer_header button"
);
const btnSideBarListLi = document.querySelector(
  ".sidebarcontainer_menu_list li"
);
...
btnFav.addEventListener("click", () => {
  ...
  if (searchStatus == false) {
    ...
    addToLocalStorage(
      finalResultMeal.idMeal,
      finalResultMeal.strMeal,
      finalResultMeal.strInstructions,
      finalResultMeal.strMealThumb
    );
    searchStatus == false;
  }
});
...
btnFindSearch.addEventListener("click", () => {
  const inputValueSearch = document.querySelector(
    ".header_container_searchmeal input"
  ).value;
